...
## Phase 2: Agent Adoption & Wrappers (v0.3)
...
## Phase 3.5: The Monorepo Upgrade (v0.5.0)
...
## Phase 4: Enterprise Scale & Ecosystem (v1.0+)
...
- [ ] **msh-fleet** — The enterprise control plane for managing, auditing, and securing thousands of concurrent `msh` agents across a distributed infrastructure.
